 ...
 */
final class Version20190730093805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE versement (id INT AUTO_INCREMENT NOT NULL, partenaire_id INT NOT NULL, montant BIGINT NOT NULL, date_versement DATETIME NOT NULL, caissier INT NOT NULL, INDEX IDX_716E936798DE13AC (partenaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
